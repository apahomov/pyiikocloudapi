...
class AsyncBaseAPI:
    ...
    async def _post_request(self, url: str, data: dict = None, timeout=DEFAULT_TIMEOUT, model_response_data=None,
        ...
        for attempt in range(2):
            ...
            self.__last_data = json.loads(response.content)
            del self.timeout
            return result
...
class AsyncCommands(AsyncBaseAPI):
    async def status(self, organization_id: str, correlation_id: str, timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
...
class AsyncDictionaries(AsyncBaseAPI):
    async def cancel_causes(self, organization_ids: List[str], timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
    ...
    async def order_types(self, organization_ids: List[str], timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
    ...
    async def discounts(self, organization_ids: List[str], timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
    ...
    async def payment_types(self, organization_ids: List[str], timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
    ...
    async def removal_types(self, organization_ids: List[str], timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
...
class AsyncDiscountPromotion(AsyncBaseAPI):
...
class AsyncMenu(AsyncBaseAPI):
    async def nomenclature(self, organization_id: str, start_revision: int = None,
    ...
    async def menu(self, timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[CustomErrorModel, BaseMenuModel]:
        try:
    ...
    async def menu_by_id(self, external_menu_id: str, organization_ids: List[str], price_category_id: str = None,
                         timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
    ...
    async def stop_lists(self, organization_ids: List[str], return_size: bool = False,
    ...
    async def stop_lists_check(self, organization_id: str, terminal_group_id: str,
                               items: dict,
                               timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
    ...
    async def combo(self, organization_id: str, timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
        CustomErrorModel, BaseComboModel]:
    ...
    async def combo_calculate(self, organization_id: str, items: dict, timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
...
class AsyncTerminalGroup(AsyncBaseAPI):
    async def terminal_groups(self, organization_ids: List[str], include_disabled: bool = False,
                              timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[CustomErrorModel,
    ...
    async def is_alive(self, organization_ids: List[str], terminal_group_ids: List[str],
                       timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[CustomErrorModel,
    BaseTGIsAliveyModel]:
        """
...
class AsyncDeliveryRestrictions(AsyncBaseAPI):
    async def delivery_restrictions(self, organization_ids: List[str], timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
        CustomErrorModel,]:
        if not bool(organization_ids):
            raise ParamSetException(self.__class__.__qualname__,
    ...
    async def dr_allowed(self, organization_ids: List[str], is_courier_delivery: bool,
...
class AsyncOrders(AsyncBaseAPI):
    async def order_create(self, organization_id: str, terminal_group_id: str, order: dict,
                           create_order_settings: Optional[int] = None, timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
        CustomErrorModel,
    ...
    async def order_by_table(self,
                             organization_ids: List[str],
                             table_ids: List[str],
                             source_keys: List[str] = None,
                             statuses: List[str] = None,
                             date_from: str = None,
                             date_to: str = None, timeout=AsyncBaseAPI.DEFAULT_TIMEOUT
                             ) -> Union[CustomErrorModel, ByIdModel]:
        """
...
class AsyncEmployees(AsyncBaseAPI):
    ...
    @experimental
    async def employees_couriers_by_role(self, timeout=AsyncBaseAPI.DEFAULT_TIMEOUT):
        pass

    @experimental
    async def employees_couriers_active_location_by_terminal(self, timeout=AsyncBaseAPI.DEFAULT_TIMEOUT):
        pass

    @experimental
    async def employees_couriers_active_location(self, timeout=AsyncBaseAPI.DEFAULT_TIMEOUT):
        pass
...
class AsyncCustomers(AsyncBaseAPI):
    async def customer_info(self, organization_id: str, identifier: str, type: str,
                            timeout=AsyncBaseAPI.DEFAULT_TIMEOUT) -> Union[
