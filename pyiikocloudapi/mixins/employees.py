...
class Employees(BaseAPI):
    ...
    def employees_shift_clockout(
        self, organization_id: str, terminal_group_id: str, employee_id: str, timeout=BaseAPI.DEFAULT_TIMEOUT
    ):
        """
